var playern1,playern2;
function displayNames(){
    playern1 = document.getElementById('player1').value;
    playern2 = document.getElementById('player2').value;

    var outputElement = document.getElementById("output");
    outputElement.textContent = "Player 1 - "+playern1+" Player 2 - "+playern2;
}
function myfunc() {
    ...
    if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' || b2 == 'X') && (b3 == 'x' || b3 == 'X')) {
        document.getElementById('print').innerHTML =`Player ${playern1} Won`;
    ...
    // not and after that disabled all the other fields 
        ...
        b2 == '0') && (b3 == '0' || b3 == '0')) {
        document.getElementById('print').innerHTML = `Player ${playern2} Won`;
        b4btn.disabled = true;
        b5btn.disabled = true;
        b6btn.disabled = true;
        b7btn.disabled = true;
    ...
    document.getElementById('print') 
        .innerHTML = `Match Tie between ${playern1} and ${playern2}`; 
}     
else { 
    // Here, Printing Result 
    if (flag == 1) { 
        document.getElementById('print') 
            .innerHTML = `Player ${playern1} Turn`; 
    } 
    else { 
        document.getElementById('print') 
            .innerHTML = `Player ${playern2} Turn`; 
    } 
} 
}
